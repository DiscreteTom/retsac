...
export class Grammar {
  ...
  /**
   * Same as `ASTNode.getStringWithName`.
   */
  readonly strWithName: StringCache;
  /**
   * Same as `ASTNode.getStringWithoutName`.
   */
   ...
   */
  readonly grammarStrWithName: StringCache;
  /**
  ...
  constructor(
    p: Pick<Grammar, "type" | "kind" | "name" | "text"> & {
      /**
       * Reuse this generated by grammar repo.
       */
      strWithName: string;
    }
  ) {
    ...
    this.strWithName = new StringCache(
      () => ASTNode.getStringWithName(this),
      p.strWithName
    );
    this.strWithoutName = new StringCache(() => ASTNode.getString(this));
    this.grammarStrWithName = new StringCache(() =>
      Grammar.getGrammarStringWithName(this)
    );
  ...
  static getGrammarStringWithName(
    data: Pick<Grammar, "kind" | "name" | "text">
  ) {
    return (
      (data.text != undefined
...
export class GrammarSet {
  ...
  add(g: Grammar) {
    ...
    this.gs.set(g.toStringWithoutName(), g);
    return true;
  }

  has(g: Readonly<Grammar> | Readonly<ASTNode<any, any>>) {
    return this.gs.has(g.toStringWithoutName()); // Grammar & ASTNode has the same string format
  }
